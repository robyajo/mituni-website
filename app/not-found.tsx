  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 text-center sm:px-6 lg:px-8">
      <div className="animate-bounce">
        <span className="bg-linear-to-b from-foreground to-transparent bg-clip-text text-[8rem] sm:text-[10rem] font-extrabold leading-none text-transparent animate-pulse">
          404
        </span>
      </div>
